...
+-----------------------------------------------------------------+
| GRANT REPLICATION CLIENT ON _._ TO 'holberton_user'@'localhost' |
+-----------------------------------------------------------------+
ubuntu@229-web-01:~$
Repo:
...
CREATE DATABASE /_!32312 IF NOT EXISTS_/ `tyrell_corp` /_!40100 DEFAULT CHARACTER SET latin1 _/;
